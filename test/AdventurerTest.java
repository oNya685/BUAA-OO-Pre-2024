...
public class AdventurerTest
{
    ...
    @Test
    public void removeItemInRepository()
    {
        Adventurer adventurer = new Adventurer(37, "oNya");
        Equipment equipment = new Equipment(0, "Air Sword", 0);
        adventurer.addEquipment(equipment);
        adventurer.carryItem(equipment);
        assertEquals(adventurer.isInRepository(equipment), true);
        adventurer.removeItemInRepository(equipment);
        assertEquals(adventurer.isInRepository(equipment), false);
    }
