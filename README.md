...
![未命名的设计](http://api.oo.buaa.edu.cn/image/2024_08_12_20_20_12_3d3697bec3f9f09af9209e60ebebcc498d8bc3f6)
...
![21098a40ad82744b3f42ff587a0d2b0](http://api.oo.buaa.edu.cn/image/2024_08_12_20_18_45_f509551518824e8dd1203028aab3976f037da31c)

#### IDEA（推荐）

打开 IDEA，选择 **“从版本控制中获取”**。

![d45ab26e8b99d6a069c4115adde478c](http://api.oo.buaa.edu.cn/image/2024_08_12_20_19_26_d060c4f8e0401e859e3abd81f794b5c07916bbc6)

填入作业仓库的远程链接（获取方式与上述相同），点击克隆即可。

![image-20240812141343621](http://api.oo.buaa.edu.cn/image/2024_08_12_20_19_44_149c3e57429a63853f6370e10c5c4eab321653bc)
...
![image-20240812141919215](http://api.oo.buaa.edu.cn/image/2024_08_12_20_19_57_de20f6a5cb2178217bfc6b3d68545f7187487e89)

填写本次提交的提交消息，然后点击 **“提交”**。提交后，本次更改将会保存在本地，要将其推送至远程仓库中，需要点击上图中的“推送”。当然，你也可以点击 **“提交并推送”** 来一次性进行两个操作。

![9e8bb6a2db147e876d44e782ac2f99b](http://api.oo.buaa.edu.cn/image/2024_08_12_20_18_16_e621792bc02d15d82f378640217d24cf15bd69b3)
...
![65eb755831969042788c48f5c37028b](http://api.oo.buaa.edu.cn/image/2024_08_12_20_18_31_8f2c59cbdec8b06a7b7caa723d297df890a868a3)
...
第 111 行一个字符串，表示虚拟宠物的名字；第 2,3,42,3,42,3,4 行一行一个非负整数，依次表示虚拟宠物的初始饥饿度、快乐度和健康度。

从第 555 行开始，你将从标准输入读取一系列指令，直到遇到结束指令为止。每个指令可以是以下几种之一：
